...
const NavBar = ({ onToggleSidebar, data }) => {
  const [, setShowPlusDropdown] = useState(false);
  ...
  return (
    <div className="flex py-2 px-6 justify-between items-center">
      ...
      <div className="plus flex items-center gap-3 relative">
        ...
        {/* Icons */}
        {/* rgb(224,224,224) */}
        <MdOutlineLightMode className="text-[rgb(139,139,139)] hover:cursor-pointer" />
        <HiArrowsPointingOut className="text-[rgb(139,139,139)] hover:cursor-pointer" />
        <CiGlobe className="text-[rgb(139,139,139)] hover:cursor-pointer" />
