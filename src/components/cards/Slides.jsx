const Slide = ({
  ...
  return (
    <div className="w-[280px] p-3 pb-6" slide={slide}>
      <div
        className={`w-[280px] cursor-pointer h-[310px] bg-no-repeat bg-cover bg-center items-center flex gap-2 flex-col p-3 text-black border border-[rgb(233,234,242)] rounded-lg`}
      >
        <div className="flex flex-col w-full gap-3">
          <div className="w-[w-full] h-[150px] rounded-md">
            <img
          ...
          <div className="flex flex-col justify-between w-full mt-3 gap-3">
            <span className="bg-[rgb(194,233,235)] p-1 rounded-md font-semibold text-xs w-max ">
              {tagA}
            </span>
