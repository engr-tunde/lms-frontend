...
const Course = ({people, title, details, image, name, position, action, normal, img}) => {
    ...
    return (
        <div className="relative">
            <div className={`w-[280px] bg-[url("/images/health_10.jpg")] h-[400px] bg-no-repeat bg-cover bg-center justify-end items-center flex gap-2 flex-col p-3 text-black rounded-lg`}>
