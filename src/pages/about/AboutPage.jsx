      ...
      <div className="w-full flex flex-col justify-center items-center">
            ...
            <div className="flex w-full justify-between items-center mt-16">
              ...
              <div className="flex flex-col gap-2.5 w-[400px]">
                ...
                <p>
                  ...
                  Fugit eius accusamus non, tempore facere veniam odit? Eos
                  laudantium voluptas amet nobis beatae harum tenetur animi
                  enim. Sequi culpa ex voluptas accusamus error perspiciatis,
                  fugit ducimus doloremque numquam qui vero quas quod optio
                  magni modi! Quae voluptates adipisci laboriosam deserunt
                  sequi!
                </p>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-10 p-10 w-full bg-primary-deep text-white">
          <div className="flex flex-col gap-3 justify-center items-center">
            ...
            <p className="text-lg text-center w-[790px]">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nam
              similique blanditiis ab ex? Quibusdam praesentium minima quos
              sapiente ad vel voluptatibus, alias sunt accusantium excepturi!
            </p>
          </div>
        ...
        <div className="flex w-full flex-col gap-5 justify-center items-center p-10 py-28">
          <div className="flex flex-col gap-3 justify-center items-center">
            <div className="text-center w-[62%] text-[19px]">
            ...
            <Link
              to=""
              className="bg-black text-white p-2 text-lg font-semibold"
            >
              Learn More
            </Link>
          </div>
