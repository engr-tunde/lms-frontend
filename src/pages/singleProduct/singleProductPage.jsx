...
import RelatedTopic from "../../components/cards/relatedTopic";
                    ...
                    <div className="w-[90%] p-20 grid grid-cols-3 gap-4  justify-center ">
                        <div className="w-full flex flex-col col-span-2 gap-2">
                            <div className="border border-[hsl(236,19%,85%)] p-2">
                                <div className="text-2xl font-bold ml-6 p-3">What you'll learn</div>
                            ...
                            <div className="flex flex-col gap-2 w-full mt-10">
                                <h3  className="text-2xl font-semibold">Explore related topics</h3>
                                    ...
                                    <div className="border border-[rgb(209,210,224)] w-full mt-3">
                                        {
                                            singleCourseContent.map((item, i) => {
                                                ...
                                                return (
                                                    <div className="w-full" key={i} onClick={() => setOpenIndex(isOpen ? null : i)}>
                                                        <CourseContentCard title={item.title} objectives={item.objective} isOpen={isOpen} /> 
                                                    </div>
                                                )
                            ...
                            <div className="mt-3 w-full">
                                ...
                                <ul className="flex flex-col gap-2 list-disc w-full px-4 text-sm">
                                    <li>A basic understanding of Salesforce and Salesforce Development is ideal. You should ideally know how to setup a free Salesforce development org, and what an IDE (Integrated Development Environment) is and how to set one up. However if you are unfamiliar with how to setup an IDE for Salesforce there are linked tutorials in the notes for this course that will get you up to speed!</li>
                                    <li>A basic understanding of Salesforce Administration is ideal, however there are tutorials in the notes for this course that will easily get you up to speed on the admin information you need to know if you're brand new to Salesforce.</li>
                                </ul>
                            </div>
                            <div className="mt-3 w-full">
                                <h3 className="text-xl font-bold mb-2">Description</h3>
                                <div className="text-sm">
                                    In this course, Matt Gerry, founder of Coding With The Force, with 10+ years of experience on the Salesforce platform, who is also one of only ~500 Salesforce Certified Technical Architects Worldwide, teaches students everything they need to know to be as efficient and effective as possible when utilizing AI powered IDE's and IDE plugins on the Salesforce platform.Whether you are a beginner, intermediate, or advanced Salesforce developer, this course will have something for you! <br /> <br />
                                    Throughout this course we'll go over absolutely everything related to AI code assistants and how to leverage them to speed up your Salesforce development. We'll start by going over the basics of what AI, LLM's, and Agents
                                </div>
                            </div>
                        </div>
                        <div className="col-span-1 border border-[rgb(209,210,224)] h-[550px] p-2 flex flex-col">
                            <div className="w-full mb-8 "><img className="w-full" src="/images/soft-health-skills.jpg" alt="" /></div>
                                ...
                                <div className="flex flex-col gap-2 text-sm">
                                    {
                                            aboutComponent.map((item, i) => {
                                                ...
                                                return (
                                                    <div key={i}>
                                                        <AboutOfferComponent Icon={icon ? icon : icon2 }  value={item.value}/>
                                                    </div>
